...
int RunImGui()
{
	WNDCLASSEX wc = { sizeof(WNDCLASSEX), ACS_TRANSPARENT, WndProc, 0L, 0L, GetModuleHandle(NULL), NULL, LoadCursor(NULL, IDC_ARROW), NULL, NULL, _T("yes"), NULL };
	RegisterClassEx(&wc);
	HWND hwnd = CreateWindowExA(WS_EX_TOPMOST | WS_EX_TRANSPARENT | WS_EX_NOACTIVATE, "yes", "yes", WS_POPUP, 0, 0, screenX, screenY, NULL, NULL, wc.hInstance, NULL);
	MARGINS margins = { -1 };
	...
	while (msg.message != WM_QUIT)
	{
		...
		static bool guiclicks = true;
		static bool show_gui_1 = true;
		...
		if (show_gui_1)
		{
			...
			ImGui::Begin("luau addys 5/1/21", NULL, ImGuiWindowFlags_NoResize);
